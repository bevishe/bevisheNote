...
![image-20210113150858976](https://bevishe.oss-cn-hangzhou.aliyuncs.com/img/image-20210113150858976.png)
...
* 3.errorPageCustomizer
  ...
  * ```java
  	public void registerErrorPages(ErrorPageRegistry errorPageRegistry) {
  		...
  		private String path = "/error"; // 系统出现错误来到errror请求进行处理，（web.xml注册的错误页面规则）
  	```
...
步骤：
一旦系统出现4XX和5XX错误，errorPageCustomeizer就会生效，就会来到/error请求；就会被BasicErorController请求，
